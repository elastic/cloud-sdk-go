			...
			args: args{params: CreateParams{
				...
				API: api.NewMock(mock.Response{
					...
					Assert: &mock.RequestAssertion{
						...
						Body:   mock.NewStringBody(`{"allowed_zones":[],"description":"Instance configuration to be used for Kibana","discrete_sizes":{"default_size":1024,"resource":"memory","sizes":[1024,2048,4096,8192]},"instance_type":"kibana","name":"kibana","storage_multiplier":4}` + "\n"),
