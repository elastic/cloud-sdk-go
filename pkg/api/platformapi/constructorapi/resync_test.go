...
func TestResync(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			wantErr: &url.Error{
				Op:  "Post",
				URL: "https://mock.elastic.co/api/v1/regions/platform/infrastructure/constructors/2c221bd86b7f48959a59ee3128d5c5e8/_resync",
...
func TestResyncAll(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			wantErr: &url.Error{
				Op:  "Post",
				URL: "https://mock.elastic.co/api/v1/regions/platform/infrastructure/constructors/_resync?skip_matching_version=true",
				Err: errors.New("error with API"),
			},
		},
		{
