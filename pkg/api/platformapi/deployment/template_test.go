...
func TestList(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			wantErr: true,
			error:   `Get https://mock.elastic.co/api/v1/platform/configuration/templates/deployments?format=cluster&show_hidden=false&show_instance_configurations=false: error`,
		},
		{
  ...
  "metadata": [{
	...
	tests := []struct {
		...
		},
		{
			...
			wantErr: true,
			error:   `Get https://mock.elastic.co/api/v1/platform/configuration/templates/deployments/84e0bd6d69bb44e294809d89cea88a7e?format=cluster&show_instance_configurations=false: error`,
		},
		{
...
func TestDelete(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			wantErr: true,
			error:   `Delete https://mock.elastic.co/api/v1/platform/configuration/templates/deployments/84e0bd6d69bb44e294809d89cea88a7e: error`,
		},
		{
...
func TestCreate(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			wantErr: true,
			error:   `Post https://mock.elastic.co/api/v1/platform/configuration/templates/deployments: error`,
		},
		{
...
func TestUpdate(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			wantErr: true,
			error:   `Put https://mock.elastic.co/api/v1/platform/configuration/templates/deployments/84e0bd6d69bb44e294809d89cea88a7e?create_only=false: error`,
		},
		{
