...
func (o *GetAllocatorLoggingSettingsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetAllocatorLoggingSettingsOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 404:
		result := NewGetAllocatorLoggingSettingsNotFound()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func NewGetAllocatorLoggingSettingsOK() *GetAllocatorLoggingSettingsOK {
	return &GetAllocatorLoggingSettingsOK{}
}
...
func (o *GetAllocatorLoggingSettingsOK) Code() int {
	return 200
}

func (o *GetAllocatorLoggingSettingsOK) Error() string {
	return fmt.Sprintf("[GET /platform/infrastructure/allocators/{allocator_id}/logging_settings][%d] getAllocatorLoggingSettingsOK  %+v", 200, o.Payload)
}

func (o *GetAllocatorLoggingSettingsOK) String() string {
	return fmt.Sprintf("[GET /platform/infrastructure/allocators/{allocator_id}/logging_settings][%d] getAllocatorLoggingSettingsOK  %+v", 200, o.Payload)
}

func (o *GetAllocatorLoggingSettingsOK) GetPayload() *models.LoggingSettings {
	return o.Payload
}

func (o *GetAllocatorLoggingSettingsOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewGetAllocatorLoggingSettingsNotFound() *GetAllocatorLoggingSettingsNotFound {
	return &GetAllocatorLoggingSettingsNotFound{}
}
...
func (o *GetAllocatorLoggingSettingsNotFound) IsSuccess() bool {
	return false
}
...
func (o *GetAllocatorLoggingSettingsNotFound) IsCode(code int) bool {
	return code == 404
}

// Code gets the status code for the get allocator logging settings not found response
func (o *GetAllocatorLoggingSettingsNotFound) Code() int {
	return 404
}

func (o *GetAllocatorLoggingSettingsNotFound) Error() string {
	return fmt.Sprintf("[GET /platform/infrastructure/allocators/{allocator_id}/logging_settings][%d] getAllocatorLoggingSettingsNotFound  %+v", 404, o.Payload)
}

func (o *GetAllocatorLoggingSettingsNotFound) String() string {
	return fmt.Sprintf("[GET /platform/infrastructure/allocators/{allocator_id}/logging_settings][%d] getAllocatorLoggingSettingsNotFound  %+v", 404, o.Payload)
}

func (o *GetAllocatorLoggingSettingsNotFound) GetPayload() *models.BasicFailedReply {
	return o.Payload
}

func (o *GetAllocatorLoggingSettingsNotFound) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
