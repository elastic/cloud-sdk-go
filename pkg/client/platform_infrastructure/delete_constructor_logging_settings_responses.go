...
/*DeleteConstructorLoggingSettingsOK handles this case with default header values.
...
/*DeleteConstructorLoggingSettingsNotFound handles this case with default header values.
