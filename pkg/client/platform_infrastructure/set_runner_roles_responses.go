...
// IsSuccess returns true when this set runner roles retry with response has a 2xx status code
func (o *SetRunnerRolesRetryWith) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this set runner roles retry with response has a 3xx status code
func (o *SetRunnerRolesRetryWith) IsRedirect() bool {
	return false
}

// IsClientError returns true when this set runner roles retry with response has a 4xx status code
func (o *SetRunnerRolesRetryWith) IsClientError() bool {
	return true
}

// IsServerError returns true when this set runner roles retry with response has a 5xx status code
func (o *SetRunnerRolesRetryWith) IsServerError() bool {
	return false
}

// IsCode returns true when this set runner roles retry with response a status code equal to that given
func (o *SetRunnerRolesRetryWith) IsCode(code int) bool {
	return code == 449
}

// Code gets the status code for the set runner roles retry with response
func (o *SetRunnerRolesRetryWith) Code() int {
	return 449
}
...
func (o *SetRunnerRolesRetryWith) String() string {
	return fmt.Sprintf("[PUT /platform/infrastructure/runners/{runner_id}/roles][%d] setRunnerRolesRetryWith  %+v", 449, o.Payload)
}
