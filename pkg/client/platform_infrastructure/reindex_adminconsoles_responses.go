...
func (o *ReindexAdminconsolesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 202:
		result := NewReindexAdminconsolesAccepted()
...
func NewReindexAdminconsolesAccepted() *ReindexAdminconsolesAccepted {
	return &ReindexAdminconsolesAccepted{}
}
...
func (o *ReindexAdminconsolesAccepted) Code() int {
	return 202
}

func (o *ReindexAdminconsolesAccepted) Error() string {
	return fmt.Sprintf("[POST /platform/infrastructure/adminconsoles/_reindex][%d] reindexAdminconsolesAccepted  %+v", 202, o.Payload)
}

func (o *ReindexAdminconsolesAccepted) String() string {
	return fmt.Sprintf("[POST /platform/infrastructure/adminconsoles/_reindex][%d] reindexAdminconsolesAccepted  %+v", 202, o.Payload)
}

func (o *ReindexAdminconsolesAccepted) GetPayload() models.EmptyResponse {
	return o.Payload
}

func (o *ReindexAdminconsolesAccepted) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
