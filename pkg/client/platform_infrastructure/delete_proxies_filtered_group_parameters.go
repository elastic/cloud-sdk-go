...
func (o *DeleteProxiesFilteredGroupParams) WithDefaults() *DeleteProxiesFilteredGroupParams {
	o.SetDefaults()
	return o
}
...
func (o *DeleteProxiesFilteredGroupParams) WithVersion(version *string) *DeleteProxiesFilteredGroupParams {
