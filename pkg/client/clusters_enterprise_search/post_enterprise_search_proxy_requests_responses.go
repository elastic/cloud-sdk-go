...
func (o *PostEnterpriseSearchProxyRequestsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewPostEnterpriseSearchProxyRequestsOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 404:
		result := NewPostEnterpriseSearchProxyRequestsNotFound()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func NewPostEnterpriseSearchProxyRequestsOK() *PostEnterpriseSearchProxyRequestsOK {
	return &PostEnterpriseSearchProxyRequestsOK{}
}
...
func (o *PostEnterpriseSearchProxyRequestsOK) Error() string {
	return fmt.Sprintf("[POST /clusters/enterprise_search/{cluster_id}/proxy/{enterprise_search_path}][%d] postEnterpriseSearchProxyRequestsOK ", 200)
}

func (o *PostEnterpriseSearchProxyRequestsOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewPostEnterpriseSearchProxyRequestsNotFound() *PostEnterpriseSearchProxyRequestsNotFound {
	return &PostEnterpriseSearchProxyRequestsNotFound{}
}
...
func (o *PostEnterpriseSearchProxyRequestsNotFound) Error() string {
	return fmt.Sprintf("[POST /clusters/enterprise_search/{cluster_id}/proxy/{enterprise_search_path}][%d] postEnterpriseSearchProxyRequestsNotFound  %+v", 404, o.Payload)
}
func (o *PostEnterpriseSearchProxyRequestsNotFound) GetPayload() *models.BasicFailedReply {
	return o.Payload
}

func (o *PostEnterpriseSearchProxyRequestsNotFound) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
