...
func (o *PutEnterpriseSearchProxyRequestsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewPutEnterpriseSearchProxyRequestsOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 404:
		result := NewPutEnterpriseSearchProxyRequestsNotFound()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func NewPutEnterpriseSearchProxyRequestsOK() *PutEnterpriseSearchProxyRequestsOK {
	return &PutEnterpriseSearchProxyRequestsOK{}
}
...
func (o *PutEnterpriseSearchProxyRequestsOK) Error() string {
	return fmt.Sprintf("[PUT /clusters/enterprise_search/{cluster_id}/proxy/{enterprise_search_path}][%d] putEnterpriseSearchProxyRequestsOK ", 200)
}

func (o *PutEnterpriseSearchProxyRequestsOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewPutEnterpriseSearchProxyRequestsNotFound() *PutEnterpriseSearchProxyRequestsNotFound {
	return &PutEnterpriseSearchProxyRequestsNotFound{}
}
...
func (o *PutEnterpriseSearchProxyRequestsNotFound) Error() string {
	return fmt.Sprintf("[PUT /clusters/enterprise_search/{cluster_id}/proxy/{enterprise_search_path}][%d] putEnterpriseSearchProxyRequestsNotFound  %+v", 404, o.Payload)
}
func (o *PutEnterpriseSearchProxyRequestsNotFound) GetPayload() *models.BasicFailedReply {
	return o.Payload
}

func (o *PutEnterpriseSearchProxyRequestsNotFound) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
