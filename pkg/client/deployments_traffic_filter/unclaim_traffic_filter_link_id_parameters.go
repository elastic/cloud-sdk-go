...
// NewUnclaimTrafficFilterLinkIDParams creates a new UnclaimTrafficFilterLinkIDParams object,
...
func NewUnclaimTrafficFilterLinkIDParams() *UnclaimTrafficFilterLinkIDParams {
	return &UnclaimTrafficFilterLinkIDParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewUnclaimTrafficFilterLinkIDParamsWithTimeout creates a new UnclaimTrafficFilterLinkIDParams object
...
// NewUnclaimTrafficFilterLinkIDParamsWithContext creates a new UnclaimTrafficFilterLinkIDParams object
...
// NewUnclaimTrafficFilterLinkIDParamsWithHTTPClient creates a new UnclaimTrafficFilterLinkIDParams object
...
func (o *UnclaimTrafficFilterLinkIDParams) WithDefaults() *UnclaimTrafficFilterLinkIDParams {
	o.SetDefaults()
	return o
}
...
func (o *UnclaimTrafficFilterLinkIDParams) WithTimeout(timeout time.Duration) *UnclaimTrafficFilterLinkIDParams {
...
func (o *UnclaimTrafficFilterLinkIDParams) WithContext(ctx context.Context) *UnclaimTrafficFilterLinkIDParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the unclaim traffic filter link id params
func (o *UnclaimTrafficFilterLinkIDParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the unclaim traffic filter link id params
func (o *UnclaimTrafficFilterLinkIDParams) WithHTTPClient(client *http.Client) *UnclaimTrafficFilterLinkIDParams {
...
func (o *UnclaimTrafficFilterLinkIDParams) WithBody(body *models.TrafficFilterClaimedLinkIDRequest) *UnclaimTrafficFilterLinkIDParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the unclaim traffic filter link id params
func (o *UnclaimTrafficFilterLinkIDParams) SetBody(body *models.TrafficFilterClaimedLinkIDRequest) {
	o.Body = body
}

// WriteToRequest writes these params to a swagger request
func (o *UnclaimTrafficFilterLinkIDParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
