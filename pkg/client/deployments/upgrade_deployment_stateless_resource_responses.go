...
// IsSuccess returns true when this upgrade deployment stateless resource retry with response has a 2xx status code
func (o *UpgradeDeploymentStatelessResourceRetryWith) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this upgrade deployment stateless resource retry with response has a 3xx status code
func (o *UpgradeDeploymentStatelessResourceRetryWith) IsRedirect() bool {
	return false
}

// IsClientError returns true when this upgrade deployment stateless resource retry with response has a 4xx status code
func (o *UpgradeDeploymentStatelessResourceRetryWith) IsClientError() bool {
	return true
}

// IsServerError returns true when this upgrade deployment stateless resource retry with response has a 5xx status code
func (o *UpgradeDeploymentStatelessResourceRetryWith) IsServerError() bool {
	return false
}

// IsCode returns true when this upgrade deployment stateless resource retry with response a status code equal to that given
func (o *UpgradeDeploymentStatelessResourceRetryWith) IsCode(code int) bool {
	return code == 449
}

// Code gets the status code for the upgrade deployment stateless resource retry with response
func (o *UpgradeDeploymentStatelessResourceRetryWith) Code() int {
	return 449
}
...
func (o *UpgradeDeploymentStatelessResourceRetryWith) String() string {
	return fmt.Sprintf("[POST /deployments/{deployment_id}/{stateless_resource_kind}/{ref_id}/_upgrade][%d] upgradeDeploymentStatelessResourceRetryWith  %+v", 449, o.Payload)
}
