...
// NewGetDeploymentEsResourceSnapshotDependencyParams creates a new GetDeploymentEsResourceSnapshotDependencyParams object,
...
func NewGetDeploymentEsResourceSnapshotDependencyParams() *GetDeploymentEsResourceSnapshotDependencyParams {
	return &GetDeploymentEsResourceSnapshotDependencyParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewGetDeploymentEsResourceSnapshotDependencyParamsWithTimeout creates a new GetDeploymentEsResourceSnapshotDependencyParams object
...
// NewGetDeploymentEsResourceSnapshotDependencyParamsWithContext creates a new GetDeploymentEsResourceSnapshotDependencyParams object
...
// NewGetDeploymentEsResourceSnapshotDependencyParamsWithHTTPClient creates a new GetDeploymentEsResourceSnapshotDependencyParams object
...
func (o *GetDeploymentEsResourceSnapshotDependencyParams) WithDefaults() *GetDeploymentEsResourceSnapshotDependencyParams {
	o.SetDefaults()
	return o
}
...
//
// All values with no default are reset to their zero value.
func (o *GetDeploymentEsResourceSnapshotDependencyParams) SetDefaults() {
	// no default values defined for this parameter
}

// WithTimeout adds the timeout to the get deployment es resource snapshot dependency params
func (o *GetDeploymentEsResourceSnapshotDependencyParams) WithTimeout(timeout time.Duration) *GetDeploymentEsResourceSnapshotDependencyParams {
	o.SetTimeout(timeout)
	return o
}

// SetTimeout adds the timeout to the get deployment es resource snapshot dependency params
func (o *GetDeploymentEsResourceSnapshotDependencyParams) SetTimeout(timeout time.Duration) {
	o.timeout = timeout
}

// WithContext adds the context to the get deployment es resource snapshot dependency params
func (o *GetDeploymentEsResourceSnapshotDependencyParams) WithContext(ctx context.Context) *GetDeploymentEsResourceSnapshotDependencyParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the get deployment es resource snapshot dependency params
func (o *GetDeploymentEsResourceSnapshotDependencyParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the get deployment es resource snapshot dependency params
func (o *GetDeploymentEsResourceSnapshotDependencyParams) WithHTTPClient(client *http.Client) *GetDeploymentEsResourceSnapshotDependencyParams {
	o.SetHTTPClient(client)
	return o
}

// SetHTTPClient adds the HTTPClient to the get deployment es resource snapshot dependency params
func (o *GetDeploymentEsResourceSnapshotDependencyParams) SetHTTPClient(client *http.Client) {
	o.HTTPClient = client
}

// WithDeploymentID adds the deploymentID to the get deployment es resource snapshot dependency params
func (o *GetDeploymentEsResourceSnapshotDependencyParams) WithDeploymentID(deploymentID string) *GetDeploymentEsResourceSnapshotDependencyParams {
...
func (o *GetDeploymentEsResourceSnapshotDependencyParams) WithRefID(refID string) *GetDeploymentEsResourceSnapshotDependencyParams {
	o.SetRefID(refID)
	return o
}

// SetRefID adds the refId to the get deployment es resource snapshot dependency params
func (o *GetDeploymentEsResourceSnapshotDependencyParams) SetRefID(refID string) {
	o.RefID = refID
}

// WriteToRequest writes these params to a swagger request
func (o *GetDeploymentEsResourceSnapshotDependencyParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
