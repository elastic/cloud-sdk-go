...
// bindParamStopApmInstances binds the parameter instance_ids
func (o *StopApmInstancesParams) bindParamInstanceIds(formats strfmt.Registry) []string {
