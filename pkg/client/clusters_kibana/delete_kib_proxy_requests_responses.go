...
func NewDeleteKibProxyRequestsOK() *DeleteKibProxyRequestsOK {
	return &DeleteKibProxyRequestsOK{}
}
...
func (o *DeleteKibProxyRequestsOK) Error() string {
	return fmt.Sprintf("[DELETE /clusters/kibana/{cluster_id}/proxy/{kibana_path}][%d] deleteKibProxyRequestsOK ", 200)
}

func (o *DeleteKibProxyRequestsOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewDeleteKibProxyRequestsNotFound() *DeleteKibProxyRequestsNotFound {
	return &DeleteKibProxyRequestsNotFound{}
}
