...
/* StopKibanaClusterMaintenanceModeParams contains all the parameters to send to the API endpoint
   for the stop kibana cluster maintenance mode operation.
...
func (o *StopKibanaClusterMaintenanceModeParams) SetDefaults() {
	...
	val := StopKibanaClusterMaintenanceModeParams{
...
// bindParamStopKibanaClusterMaintenanceMode binds the parameter instance_ids
func (o *StopKibanaClusterMaintenanceModeParams) bindParamInstanceIds(formats strfmt.Registry) []string {
