...
func (a *Client) GetTrustedEnvs(params *GetTrustedEnvsParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetTrustedEnvsOK, error) {
	...
	if params == nil {
		params = NewGetTrustedEnvsParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "get-trusted-envs",
		Method:             "GET",
		PathPattern:        "/trusted-environments",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"https"},
		Params:             params,
		Reader:             &GetTrustedEnvsReader{formats: a.formats},
		AuthInfo:           authInfo,
	...
	success, ok := result.(*GetTrustedEnvsOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for get-trusted-envs: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
