...
func (m *EnterpriseSearchPayload) validateElasticsearchClusterRefID(formats strfmt.Registry) error {
...
func (m *EnterpriseSearchPayload) validatePlan(formats strfmt.Registry) error {
...
func (m *EnterpriseSearchPayload) validateRefID(formats strfmt.Registry) error {
...
func (m *EnterpriseSearchPayload) validateRegion(formats strfmt.Registry) error {
...
func (m *EnterpriseSearchPayload) validateSettings(formats strfmt.Registry) error {
...
func (m *EnterpriseSearchPayload) contextValidatePlan(ctx context.Context, formats strfmt.Registry) error {
...
func (m *EnterpriseSearchPayload) contextValidateSettings(ctx context.Context, formats strfmt.Registry) error {
...
func (m *EnterpriseSearchPayload) UnmarshalBinary(b []byte) error {
	var res EnterpriseSearchPayload
