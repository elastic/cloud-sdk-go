...
func (m *OrganizationInvitation) validateRoleAssignments(formats strfmt.Registry) error {
...
func (m *OrganizationInvitation) contextValidateRoleAssignments(ctx context.Context, formats strfmt.Registry) error {
