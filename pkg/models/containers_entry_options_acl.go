...
func (m *ContainersEntryOptionsACL) Validate(formats strfmt.Registry) error {
	...
	if err := m.validatePerms(formats); err != nil {
		res = append(res, err)
	}
...
func (m *ContainersEntryOptionsACL) validateID(formats strfmt.Registry) error {
...
func (m *ContainersEntryOptionsACL) validatePerms(formats strfmt.Registry) error {

	if err := validate.Required("perms", "body", m.Perms); err != nil {
		return err
	}
...
func (m *ContainersEntryOptionsACL) validateScheme(formats strfmt.Registry) error {
...
func (m *ContainersEntryOptionsACL) UnmarshalBinary(b []byte) error {
	var res ContainersEntryOptionsACL
