...
func (m *ConfigStoreOptionList) validateValues(formats strfmt.Registry) error {
...
func (m *ConfigStoreOptionList) contextValidateValues(ctx context.Context, formats strfmt.Registry) error {
