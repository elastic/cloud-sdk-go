...
func (m *AdminconsoleInfo) Validate(formats strfmt.Registry) error {
	...
	if err := m.validateAdminconsoleID(formats); err != nil {
		res = append(res, err)
	}
...
func (m *AdminconsoleInfo) validateAdminconsoleID(formats strfmt.Registry) error {

	if err := validate.Required("adminconsole_id", "body", m.AdminconsoleID); err != nil {
		return err
	}
