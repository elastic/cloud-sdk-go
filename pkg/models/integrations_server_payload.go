...
func (m *IntegrationsServerPayload) validateElasticsearchClusterRefID(formats strfmt.Registry) error {
...
func (m *IntegrationsServerPayload) validatePlan(formats strfmt.Registry) error {
...
func (m *IntegrationsServerPayload) validateRefID(formats strfmt.Registry) error {
...
func (m *IntegrationsServerPayload) validateRegion(formats strfmt.Registry) error {
...
func (m *IntegrationsServerPayload) validateSettings(formats strfmt.Registry) error {
...
func (m *IntegrationsServerPayload) contextValidatePlan(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IntegrationsServerPayload) contextValidateSettings(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IntegrationsServerPayload) UnmarshalBinary(b []byte) error {
	var res IntegrationsServerPayload
