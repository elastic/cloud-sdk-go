...
func (m *ClusterTopologyInfo) validateHealthy(formats strfmt.Registry) error {
...
func (m *ClusterTopologyInfo) validateInstances(formats strfmt.Registry) error {
...
func (m *ClusterTopologyInfo) contextValidateInstances(ctx context.Context, formats strfmt.Registry) error {
