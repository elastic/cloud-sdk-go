...
func (m *AppSearch) validateBackendPlan(formats strfmt.Registry) error {
...
func (m *AppSearch) validateDisplayName(formats strfmt.Registry) error {
...
func (m *AppSearch) validateElasticsearchClusterRefID(formats strfmt.Registry) error {
...
func (m *AppSearch) validateRefID(formats strfmt.Registry) error {
