...
func (m *BlessingsWithMeta) contextValidateMeta(ctx context.Context, formats strfmt.Registry) error {
...
func (m *BlessingsWithMeta) contextValidateValue(ctx context.Context, formats strfmt.Registry) error {
