...
func (m *ChartItem) validateTimestamp(formats strfmt.Registry) error {
...
func (m *ChartItem) validateValues(formats strfmt.Registry) error {
...
func (m *ChartItem) contextValidateValues(ctx context.Context, formats strfmt.Registry) error {
