...
func (m *StackVersionArchiveProcessingError) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *StackVersionArchiveProcessingError) validateErrors(formats strfmt.Registry) error {
...
func (m *StackVersionArchiveProcessingError) validateStackVersion(formats strfmt.Registry) error {
...
func (m *StackVersionArchiveProcessingError) UnmarshalBinary(b []byte) error {
	var res StackVersionArchiveProcessingError
