...
// StackVersionSiteSearchConfig SiteSearch related configuration of an Elastic Stack version
// swagger:model StackVersionSiteSearchConfig
...
func (m *StackVersionSiteSearchConfig) validateBlacklist(formats strfmt.Registry) error {
...
func (m *StackVersionSiteSearchConfig) validateCapacityConstraints(formats strfmt.Registry) error {
...
func (m *StackVersionSiteSearchConfig) validateDockerImage(formats strfmt.Registry) error {
...
func (m *StackVersionSiteSearchConfig) validateNodeTypes(formats strfmt.Registry) error {
...
func (m *StackVersionSiteSearchConfig) UnmarshalBinary(b []byte) error {
	var res StackVersionSiteSearchConfig
