...
func (m *DeploymentLoggingSettings) validateDestination(formats strfmt.Registry) error {
...
func (m *DeploymentLoggingSettings) contextValidateDestination(ctx context.Context, formats strfmt.Registry) error {
...
func (m *DeploymentLoggingSettings) UnmarshalBinary(b []byte) error {
	var res DeploymentLoggingSettings
