...
func (m *GlobalDeploymentTemplateInfo) contextValidateMetadata(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GlobalDeploymentTemplateInfo) contextValidateRegions(ctx context.Context, formats strfmt.Registry) error {
