...
// IntegrationsServerSystemSettings A structure that defines a curated subset of the Integrations Server settings.
...
func (m *IntegrationsServerSystemSettings) Validate(formats strfmt.Registry) error {
	return nil
}
...
func (m *IntegrationsServerSystemSettings) UnmarshalBinary(b []byte) error {
	var res IntegrationsServerSystemSettings
