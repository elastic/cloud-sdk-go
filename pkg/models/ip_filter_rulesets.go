...
// IPFilterRulesets The container for a set of IP filter rulesets.
//
// swagger:model IpFilterRulesets
...
func (m *IPFilterRulesets) validateRulesets(formats strfmt.Registry) error {
