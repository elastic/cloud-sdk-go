...
var apmPlanControlConfigurationTypeClusterRebootPropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		apmPlanControlConfigurationTypeClusterRebootPropEnum = append(apmPlanControlConfigurationTypeClusterRebootPropEnum, v)
	}
}
...
func (m *ApmPlanControlConfiguration) UnmarshalBinary(b []byte) error {
	var res ApmPlanControlConfiguration
