...
func (m *ApmConfiguration) validateSystemSettings(formats strfmt.Registry) error {
...
func (m *ApmConfiguration) contextValidateSystemSettings(ctx context.Context, formats strfmt.Registry) error {
