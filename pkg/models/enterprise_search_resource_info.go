...
func (m *EnterpriseSearchResourceInfo) validateElasticsearchClusterRefID(formats strfmt.Registry) error {
...
func (m *EnterpriseSearchResourceInfo) validateID(formats strfmt.Registry) error {
...
func (m *EnterpriseSearchResourceInfo) validateInfo(formats strfmt.Registry) error {
...
func (m *EnterpriseSearchResourceInfo) validateRefID(formats strfmt.Registry) error {
...
func (m *EnterpriseSearchResourceInfo) validateRegion(formats strfmt.Registry) error {
...
func (m *EnterpriseSearchResourceInfo) contextValidateInfo(ctx context.Context, formats strfmt.Registry) error {
...
func (m *EnterpriseSearchResourceInfo) UnmarshalBinary(b []byte) error {
	var res EnterpriseSearchResourceInfo
