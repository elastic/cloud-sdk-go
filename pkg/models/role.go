...
func (m *Role) Validate(formats strfmt.Registry) error {
	...
	if err := m.validateAutoBlessed(formats); err != nil {
		res = append(res, err)
	}
...
func (m *Role) validateAutoBlessed(formats strfmt.Registry) error {

	if err := validate.Required("auto_blessed", "body", m.AutoBlessed); err != nil {
		return err
	}
...
func (m *Role) validateContainers(formats strfmt.Registry) error {
