...
func (m *DeploymentsListResponse) validateDeployments(formats strfmt.Registry) error {
...
func (m *DeploymentsListResponse) contextValidateDeployments(ctx context.Context, formats strfmt.Registry) error {
...
func (m *DeploymentsListResponse) UnmarshalBinary(b []byte) error {
	var res DeploymentsListResponse
