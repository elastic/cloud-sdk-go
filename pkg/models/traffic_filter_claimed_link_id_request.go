...
func (m *TrafficFilterClaimedLinkIDRequest) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *TrafficFilterClaimedLinkIDRequest) validateRegion(formats strfmt.Registry) error {
...
func (m *TrafficFilterClaimedLinkIDRequest) UnmarshalBinary(b []byte) error {
	var res TrafficFilterClaimedLinkIDRequest
