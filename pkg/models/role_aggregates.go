...
func (m *RoleAggregates) validateValues(formats strfmt.Registry) error {
...
func (m *RoleAggregates) contextValidateValues(ctx context.Context, formats strfmt.Registry) error {
