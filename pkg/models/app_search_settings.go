...
func (m *AppSearchSettings) validateMetadata(formats strfmt.Registry) error {
...
func (m *AppSearchSettings) contextValidateMetadata(ctx context.Context, formats strfmt.Registry) error {
