...
func (m *Kibana) validateDisplayName(formats strfmt.Registry) error {
...
func (m *Kibana) validateElasticsearchClusterRefID(formats strfmt.Registry) error {
...
func (m *Kibana) validateRefID(formats strfmt.Registry) error {
