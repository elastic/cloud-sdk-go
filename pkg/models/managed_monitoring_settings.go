...
func (m *ManagedMonitoringSettings) Validate(formats strfmt.Registry) error {
	...
	if err := m.validateTargetClusterID(formats); err != nil {
		res = append(res, err)
	}
...
func (m *ManagedMonitoringSettings) validateTargetClusterID(formats strfmt.Registry) error {

	if err := validate.Required("target_cluster_id", "body", m.TargetClusterID); err != nil {
		return err
	}
...
func (m *ManagedMonitoringSettings) UnmarshalBinary(b []byte) error {
	var res ManagedMonitoringSettings
