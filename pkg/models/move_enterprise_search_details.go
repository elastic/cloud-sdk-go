...
func (m *MoveEnterpriseSearchDetails) validateCalculatedPlan(formats strfmt.Registry) error {
...
func (m *MoveEnterpriseSearchDetails) validateClusterID(formats strfmt.Registry) error {
...
func (m *MoveEnterpriseSearchDetails) validateErrors(formats strfmt.Registry) error {
...
func (m *MoveEnterpriseSearchDetails) contextValidateCalculatedPlan(ctx context.Context, formats strfmt.Registry) error {
...
func (m *MoveEnterpriseSearchDetails) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
...
func (m *MoveEnterpriseSearchDetails) UnmarshalBinary(b []byte) error {
	var res MoveEnterpriseSearchDetails
