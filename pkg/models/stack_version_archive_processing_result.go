...
func (m *StackVersionArchiveProcessingResult) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
...
func (m *StackVersionArchiveProcessingResult) contextValidateStacks(ctx context.Context, formats strfmt.Registry) error {
