...
func (m *RepositoryConfig) Validate(formats strfmt.Registry) error {
	...
	if err := m.validateRepositoryName(formats); err != nil {
		res = append(res, err)
	}
...
func (m *RepositoryConfig) validateRepositoryName(formats strfmt.Registry) error {

	if err := validate.Required("repository_name", "body", m.RepositoryName); err != nil {
		return err
	}
