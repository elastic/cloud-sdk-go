...
var kibanaPlanControlConfigurationTypeClusterRebootPropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		kibanaPlanControlConfigurationTypeClusterRebootPropEnum = append(kibanaPlanControlConfigurationTypeClusterRebootPropEnum, v)
	}
}
...
// prop value enum
func (m *KibanaPlanControlConfiguration) validateClusterRebootEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, kibanaPlanControlConfigurationTypeClusterRebootPropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *KibanaPlanControlConfiguration) validateClusterReboot(formats strfmt.Registry) error {
...
func (m *KibanaPlanControlConfiguration) validateMoveAllocators(formats strfmt.Registry) error {
...
func (m *KibanaPlanControlConfiguration) validateMoveInstances(formats strfmt.Registry) error {
...
func (m *KibanaPlanControlConfiguration) contextValidateMoveAllocators(ctx context.Context, formats strfmt.Registry) error {
...
func (m *KibanaPlanControlConfiguration) contextValidateMoveInstances(ctx context.Context, formats strfmt.Registry) error {
...
func (m *KibanaPlanControlConfiguration) UnmarshalBinary(b []byte) error {
	var res KibanaPlanControlConfiguration
