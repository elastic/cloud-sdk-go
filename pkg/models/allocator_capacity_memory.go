...
func (m *AllocatorCapacityMemory) validateTotal(formats strfmt.Registry) error {
...
func (m *AllocatorCapacityMemory) validateUsed(formats strfmt.Registry) error {
...
func (m *AllocatorCapacityMemory) UnmarshalBinary(b []byte) error {
	var res AllocatorCapacityMemory
