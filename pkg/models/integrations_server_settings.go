...
func (m *IntegrationsServerSettings) validateMetadata(formats strfmt.Registry) error {
...
func (m *IntegrationsServerSettings) contextValidateMetadata(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IntegrationsServerSettings) UnmarshalBinary(b []byte) error {
	var res IntegrationsServerSettings
