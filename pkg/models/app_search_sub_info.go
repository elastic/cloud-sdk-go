...
func (m *AppSearchSubInfo) Validate(formats strfmt.Registry) error {
	...
	if err := m.validateAppSearchID(formats); err != nil {
		res = append(res, err)
	}
...
func (m *AppSearchSubInfo) validateAppSearchID(formats strfmt.Registry) error {

	if err := validate.Required("app_search_id", "body", m.AppSearchID); err != nil {
		return err
	}
...
func (m *AppSearchSubInfo) validateEnabled(formats strfmt.Registry) error {
...
func (m *AppSearchSubInfo) validateLinks(formats strfmt.Registry) error {
...
func (m *AppSearchSubInfo) contextValidateLinks(ctx context.Context, formats strfmt.Registry) error {
