...
func (m *StackVersionIntegrationsServerConfig) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *StackVersionIntegrationsServerConfig) validateBlacklist(formats strfmt.Registry) error {
...
func (m *StackVersionIntegrationsServerConfig) validateCapacityConstraints(formats strfmt.Registry) error {
...
func (m *StackVersionIntegrationsServerConfig) validateDockerImage(formats strfmt.Registry) error {
...
func (m *StackVersionIntegrationsServerConfig) contextValidateCapacityConstraints(ctx context.Context, formats strfmt.Registry) error {
...
func (m *StackVersionIntegrationsServerConfig) UnmarshalBinary(b []byte) error {
	var res StackVersionIntegrationsServerConfig
