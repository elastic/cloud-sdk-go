...
func (m *ElasticsearchClusterUser) validatePasswordHash(formats strfmt.Registry) error {

	if err := validate.Required("password_hash", "body", m.PasswordHash); err != nil {
		return err
	}
...
func (m *ElasticsearchClusterUser) validateUsername(formats strfmt.Registry) error {
...
func (m *ElasticsearchClusterUser) UnmarshalBinary(b []byte) error {
	var res ElasticsearchClusterUser
