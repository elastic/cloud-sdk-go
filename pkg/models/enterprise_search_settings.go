...
func (m *EnterpriseSearchSettings) validateMetadata(formats strfmt.Registry) error {
...
func (m *EnterpriseSearchSettings) contextValidateMetadata(ctx context.Context, formats strfmt.Registry) error {
...
func (m *EnterpriseSearchSettings) UnmarshalBinary(b []byte) error {
	var res EnterpriseSearchSettings
