...
func (m *ApmSettings) validateMetadata(formats strfmt.Registry) error {
...
func (m *ApmSettings) contextValidateMetadata(ctx context.Context, formats strfmt.Registry) error {
