...
func (m *MoveKibanaClusterDetails) validateCalculatedPlan(formats strfmt.Registry) error {
...
func (m *MoveKibanaClusterDetails) validateClusterID(formats strfmt.Registry) error {
...
func (m *MoveKibanaClusterDetails) validateErrors(formats strfmt.Registry) error {
...
func (m *MoveKibanaClusterDetails) contextValidateCalculatedPlan(ctx context.Context, formats strfmt.Registry) error {
...
func (m *MoveKibanaClusterDetails) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
...
func (m *MoveKibanaClusterDetails) UnmarshalBinary(b []byte) error {
	var res MoveKibanaClusterDetails
