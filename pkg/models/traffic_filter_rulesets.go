...
func (m *TrafficFilterRulesets) validateRulesets(formats strfmt.Registry) error {
...
func (m *TrafficFilterRulesets) contextValidateRulesets(ctx context.Context, formats strfmt.Registry) error {
