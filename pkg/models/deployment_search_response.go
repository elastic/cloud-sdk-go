...
func (m *DeploymentSearchResponse) validateHealthy(formats strfmt.Registry) error {
...
func (m *DeploymentSearchResponse) validateID(formats strfmt.Registry) error {
...
func (m *DeploymentSearchResponse) validateName(formats strfmt.Registry) error {
...
func (m *DeploymentSearchResponse) validateResources(formats strfmt.Registry) error {
...
func (m *DeploymentSearchResponse) UnmarshalBinary(b []byte) error {
	var res DeploymentSearchResponse
