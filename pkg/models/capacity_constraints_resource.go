...
func (m *CapacityConstraintsResource) validateMax(formats strfmt.Registry) error {
...
func (m *CapacityConstraintsResource) validateMin(formats strfmt.Registry) error {
...
func (m *CapacityConstraintsResource) UnmarshalBinary(b []byte) error {
	var res CapacityConstraintsResource
