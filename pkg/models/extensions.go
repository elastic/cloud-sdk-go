...
func (m *Extensions) validateExtensions(formats strfmt.Registry) error {
...
func (m *Extensions) contextValidateExtensions(ctx context.Context, formats strfmt.Registry) error {
