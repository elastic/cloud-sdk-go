...
func (m *Creates) validateIntegrationsServer(formats strfmt.Registry) error {
...
func (m *Creates) contextValidateIntegrationsServer(ctx context.Context, formats strfmt.Registry) error {
