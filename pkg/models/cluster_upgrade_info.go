...
// ClusterUpgradeInfo Information about an Elasticsearch cluster upgrade.
//
...
func (m *ClusterUpgradeInfo) Validate(formats strfmt.Registry) error {
	...
	if err := m.validateClusterVersion(formats); err != nil {
		res = append(res, err)
	}
...
func (m *ClusterUpgradeInfo) validateClusterID(formats strfmt.Registry) error {
...
func (m *ClusterUpgradeInfo) validateClusterVersion(formats strfmt.Registry) error {

	if err := validate.Required("cluster_version", "body", m.ClusterVersion); err != nil {
		return err
	}
