...
func (m *ClusterMetadataResourcesSettings) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ClusterMetadataResourcesSettings) validateCPU(formats strfmt.Registry) error {
...
func (m *ClusterMetadataResourcesSettings) contextValidateCPU(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ClusterMetadataResourcesSettings) UnmarshalBinary(b []byte) error {
	var res ClusterMetadataResourcesSettings
