...
func (m *PendingStatesWithMeta) contextValidateMeta(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PendingStatesWithMeta) contextValidateValue(ctx context.Context, formats strfmt.Registry) error {
