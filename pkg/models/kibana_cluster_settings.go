...
func (m *KibanaClusterSettings) validateMetadata(formats strfmt.Registry) error {
...
func (m *KibanaClusterSettings) contextValidateMetadata(ctx context.Context, formats strfmt.Registry) error {
