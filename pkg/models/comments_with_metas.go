...
func (m *CommentsWithMetas) validateValues(formats strfmt.Registry) error {
...
func (m *CommentsWithMetas) contextValidateValues(ctx context.Context, formats strfmt.Registry) error {
