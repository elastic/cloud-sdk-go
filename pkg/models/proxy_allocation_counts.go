...
func (m *ProxyAllocationCounts) validateAllocations(formats strfmt.Registry) error {
...
func (m *ProxyAllocationCounts) validateConnectors(formats strfmt.Registry) error {

	if err := validate.Required("connectors", "body", m.Connectors); err != nil {
		return err
	}
