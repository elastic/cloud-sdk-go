	...
	tests := []struct {
		...
		},
		{
			...
			args: args{params: TrackChangeParams{
				...
				API: api.NewMock(
					planmock.MockifyStruct(foundDeploymentIDResponse),
					planmock.MockifyStruct(pendingPlan),
					planmock.MockifyStruct(secondPendingPlan),
					planmock.MockifyStruct(noMorePendingPlan),
					planmock.MockifyStruct(currentPlan),
				),
				ResourceID: "cde7b6b605424a54ce9d56316eab13a1",
				Kind:       "elasticsearch",
			}},
		...
		},
		{
			...
			args: args{params: TrackChangeParams{
				...
				API: api.NewMock(
					...
					planmock.MockifyStruct(secondPendingPlan),
					planmock.MockifyStruct(noMorePendingPlan),
					planmock.MockifyStruct(historyPlan),
				),
				ResourceID: "cde7b6b605424a54ce9d56316eab13a1",
				Kind:       "elasticsearch",
			}},
		...
		},
		{
			...
			args: args{params: TrackChangeParams{
				...
				API: api.NewMock(
					planmock.MockifyStruct(foundDeploymentIDResponse),
					planmock.MockifyStruct(pendingPlanWithDownstreamChanges),
					planmock.MockifyStruct(secondPendingPlanWithDownstreamChanges),
					planmock.MockifyStruct(noMorePendingPlan),
					planmock.MockifyStruct(currentPlanWithDownstream),
				),
				ResourceID: "cde7b6b605424a54ce9d56316eab13a1",
				Kind:       "elasticsearch",
			}},
		...
		},
		{
			...
			args: args{params: TrackChangeParams{
				...
				API: api.NewMock(
					...
					planmock.MockifyStruct(secondPendingPlanWithDownstreamChanges),
					planmock.MockifyStruct(noMorePendingPlan),
					planmock.MockifyStruct(historyPlanWithDownstream),
				),
				ResourceID: "cde7b6b605424a54ce9d56316eab13a1",
				Kind:       "elasticsearch",
			}},
